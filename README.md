...
<a href="https://github.com/user-attachments/assets/0ba41d9e-e315-46f4-a998-20397183fbdb">
  <img src="assets/hol-tcp.png" alt="TCP (HTTP/2) の Head-of-Line Blocking">
</a>

一方、QUIC は UDP ベースのプロトコルで、Stream ごとに独立したバイトストリームを持てる。パケットがロスしても、影響は該当 Stream に閉じる。

<a href="https://github.com/user-attachments/assets/59afc586-b819-4292-a9af-39d44edc24ec">
  <img src="assets/hol-quic.png" alt="QUIC (HTTP/3) の Stream 独立性">
</a>
...
<a href="https://github.com/user-attachments/assets/e84fe57d-cf83-41a9-9cbd-f3dd9b75e158">
  <img src="assets/gop.png" alt="GoP (Group of Pictures)">
</a>
