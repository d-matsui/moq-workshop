...
<video src="https://github.com/user-attachments/assets/0ba41d9e-e315-46f4-a998-20397183fbdb" poster="assets/hol-tcp.png" controls></video>

一方、QUIC は UDP ベースのプロトコルで、Stream ごとに独立したバイトストリームを持てる。パケットがロスしても、影響は該当 Stream に閉じる。

<video src="https://github.com/user-attachments/assets/59afc586-b819-4292-a9af-39d44edc24ec" poster="assets/hol-quic.png" controls></video>
...
<video src="https://github.com/user-attachments/assets/e84fe57d-cf83-41a9-9cbd-f3dd9b75e158" poster="assets/gop.png" controls></video>
